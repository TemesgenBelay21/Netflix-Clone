      ...
      <div className={styles.headerContainer}>
        ...
        <div className={styles.actions}>
          ...
          <div className={styles.profile} ref={profileRef}>
            ...
            >
              <User />
              <ChevronDown className={isProfileOpen ? styles.chevronOpen : ""} />
            </button>
            ...
            {isProfileOpen && (
              <ul className={styles.dropdownPanel}>
                ...
                <li>
                  <Link to="/account" onClick={() => setIsProfileOpen(false)}>Account</Link>
                </li>
                <li>
                  <Link to="/help" onClick={() => setIsProfileOpen(false)}>Help Center</Link>
                </li>
                <li>
                  <Link to="/settings" onClick={() => setIsProfileOpen(false)}>Settings</Link>
                </li>
                <li className={styles.signOut}>
                  <Link to="/logout" onClick={() => setIsProfileOpen(false)}>Sign out of Netflix</Link>
                </li>
              </ul>
            )}
          </div>
